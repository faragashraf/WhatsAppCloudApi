...
@Component({
  ...
  template: `
    <nav class="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-white/85 dark:bg-slate-900/80 border-b border-[var(--app-border)] dark:border-slate-700/60 shadow-[0_10px_28px_-22px_rgba(13,37,63,0.5)]">
      <div class="max-w-7xl mx-auto px-4 sm:px-5 lg:px-6 xl:px-8">
        <div class="flex justify-between items-center h-16">
          ...
          <div class="flex items-center gap-2">
            ...
            @if (tokenService.isAuthenticated()) {
              <a routerLink="/dashboard" pButton class="hidden xl:!inline-flex !bg-[var(--app-primary)] !text-white !rounded-xl hover:!bg-[var(--app-primary-strong)] !no-underline !shadow-[0_14px_30px_-18px_rgba(16,168,97,0.72)] !border-0">
              ...
              <button
                ...
                class="hidden xl:!flex !w-auto !h-10 !px-3 !gap-2 !items-center !border !border-[var(--app-border)] !bg-white/85 dark:!bg-slate-800/80">
              ...
              <a routerLink="/login" pButton [text]="true" class="hidden xl:!inline-flex !text-[var(--app-text-soft)] dark:!text-slate-300 !no-underline">
                {{ 'nav.login' | translate }}
              </a>
              <a routerLink="/register" pButton class="hidden xl:!inline-flex !bg-[var(--app-primary)] !text-white !rounded-xl hover:!bg-[var(--app-primary-strong)] !no-underline !shadow-[0_14px_30px_-18px_rgba(16,168,97,0.72)] !border-0">
                {{ 'nav.register' | translate }}
              </a>
            }

            <!-- Mobile menu -->
            <button pButton [text]="true" [rounded]="true" severity="secondary" class="xl:!hidden !w-10 !h-10 !border !border-[var(--app-border)] !bg-white/80 dark:!bg-slate-800/80" (click)="toggleMobileActionMenu()">
      ...
      @if (shouldShowPublicMobileNav()) {
        <div class="xl:hidden border-t border-[var(--app-border)] dark:border-slate-700/60 bg-white/95 dark:bg-slate-900 px-4 pb-4 pt-2 space-y-1">
