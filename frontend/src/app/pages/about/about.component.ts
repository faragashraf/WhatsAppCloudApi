    ...
    <section class="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900 pt-24 sm:pt-28 lg:pt-32 pb-16 sm:pb-20 lg:pb-24">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-3xl mx-auto">
          <div class="rounded-2xl bg-gradient-to-br from-emerald-600 to-green-700 p-7 sm:p-8 lg:p-10 text-white">
        ...
        <!-- Stats -->
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mt-14 sm:mt-16 lg:mt-20">
