    ...
    public IActionResult GetDeveloperInfo()
    {
        ...
        var info = new
        {
            ...
            Endpoints = new object[]
            {
                ...
                new { Method = "POST", Path = "/api/whatsapp/messages/media/direct", Description = "Send media message directly from local file upload (multipart/form-data)", Category = "Messaging", RequestBody = (string?)null },
                ...
                new { Method = "POST", Path = "/api/conversations/{id}/messages/media-direct", Description = "Send media in one call from local file upload (multipart/form-data)", Category = "CRM", RequestBody = (string?)null },
                new { Method = "POST", Path = "/api/conversations/{id}/messages/{messageId}/reaction", Description = "React to a specific message", Category = "CRM", RequestBody = "{ \"emoji\": \"👍\" }" },
                new { Method = "POST", Path = "/api/conversations/{id}/messages/{messageId}/forward", Description = "Forward a message to another conversation", Category = "CRM", RequestBody = "{ \"targetConversationId\": 123 }" },
